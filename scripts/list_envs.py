...
All the environments are registered in the `beam_walking` extension. They start
...
import beam_walking.tasks  # noqa: F401


def main():
    """Print all environments registered in `beam_walking` extension."""
